    ...
    <>
      <div className="modalWrapper">
        ...
        <div className="textDiv">
          <p>
            We at LEON AB respect the privacy of your personal information and,
            as such, make every effort to ensure your information is protected
            and remains private. As the owner and operator of Leon.se (the
            "Website") hereafter referred to in this Privacy Policy as "Leon",
            "us", "our" or "we", we have provided this Privacy Policy to explain
            how we collect, use, share and protect information about the users
            of our Website (hereafter referred to as “user”, “you” or "your").
            For the purposes of this Agreement, any use of the terms "Leon",
            "us", "our" or "we" includes Wasai LLC, without limitation. We will
            not use or share your personal information with anyone except as
          ...
          <p>
            ...
            we collect, the purposes for which we use the data, the ways in
            which the data is handled and your rights with regard to your
          ...
          <p>
            Leon collects information about you when you use our Website to
          ...
          <p>
            ...
            the Privacy Policy for the latest information on our privacy
            practices.
          </p>
          <p>
